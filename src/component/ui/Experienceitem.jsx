...
const Experienceitem = ({ company, role, date, description, align = "left" }) => {
  return (
    <div
      className={`w-full md:w-[500px] p-6 bg-white rounded-2xl shadow-md border 
    ...
    >
      ...
      <p contentEditable className="text-sm text-gray-500 mt-1 outline-none">
        {date}
      </p>

      <p contentEditable className="text-gray-600 mt-3 outline-none">
        {description}
      </p>
    </div>
  );
